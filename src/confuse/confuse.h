 ...
 *
 * $Id: confuse.h,v 1.2 2007-01-10 13:16:53 bakunin Exp $
 *
 ...
 */
cfg_t * __export cfg_init(cfg_opt_t *opts, cfg_flag_t flags);
 ...
 * @see cfg_parse()
 */
int __export cfg_parse_buf(cfg_t *cfg, const char *buf);
 ...
 */
void __export cfg_error(cfg_t *cfg, const char *fmt, ...);
 ...
 * @see cfg_getnint
 */
signed long cfg_opt_getnint(cfg_opt_t *opt, unsigned int index);
 ...
 * @see cfg_getint
 */
long int __export cfg_getnint(cfg_t *cfg, const char *name,
										unsigned int index);
 ...
 */
long int __export cfg_getint(cfg_t *cfg, const char *name);
 ...
 * @see cfg_getnfloat
 */
double cfg_opt_getnfloat(cfg_opt_t *opt, unsigned int index);
 ...
 * @see cfg_getfloat
 */
double __export cfg_getnfloat(cfg_t *cfg, const char *name,
										unsigned int index);
 ...
 * try to get an option that isn't declared.
 */
double __export cfg_getfloat(cfg_t *cfg, const char *name);
 ...
 * @see cfg_getnstr
 */
char *cfg_opt_getnstr(cfg_opt_t *opt, unsigned int index);
 ...
 * @see cfg_getstr
 */
char * __export cfg_getnstr(cfg_t *cfg, const char *name,
									  unsigned int index);
 ...
 * try to get an option that isn't declared.
 */
char * __export cfg_getstr(cfg_t *cfg, const char *name);
 ...
 * @see cfg_getnbool
 */
cfg_bool_t cfg_opt_getnbool(cfg_opt_t *opt, unsigned int index);
 ...
 * @see cfg_getbool
 */
cfg_bool_t __export cfg_getnbool(cfg_t *cfg, const char *name,
										   unsigned int index);
 ...
 * try to get an option that isn't declared.
 */
cfg_bool_t __export cfg_getbool(cfg_t *cfg, const char *name);
 ...
 * @see cfg_getsec
 */
cfg_t * __export cfg_getnsec(cfg_t *cfg, const char *name,
									   unsigned int index);
 ...
 * @see cfg_getsec
 */
cfg_t * __export cfg_gettsec(cfg_t *cfg, const char *name,
									   const char *title);
 ...
 */
cfg_t * __export cfg_getsec(cfg_t *cfg, const char *name);
 ...
 * @param name The name of the option.
 */
unsigned int __export cfg_size(cfg_t *cfg, const char *name);
 ...
 */
int __export cfg_include(cfg_t *cfg, cfg_opt_t *opt, int argc,
								   const char **argv);
 ...
 * by the caller.
 */
char * __export cfg_tilde_expand(const char *filename);
 ...
 */
int __export cfg_parse_boolean(const char *s);
 ...
 */
cfg_opt_t * __export cfg_getopt(cfg_t *cfg, const char *name);
 ...
 * @param value The value to set.
 */
void __export cfg_setint(cfg_t *cfg, const char *name,
								   long int value);
 ...
 * for options without the CFGF_LIST flag set.
 */
void __export cfg_setnint(cfg_t *cfg, const char *name,
									long int value, unsigned int index);
 ...
 * @param value The value to set.
 */
void __export cfg_setfloat(cfg_t *cfg, const char *name,
									 double value);
 ...
 * for options without the CFGF_LIST flag set.
 */
void __export cfg_setnfloat(cfg_t *cfg, const char *name,
									  double value, unsigned int index);
 ...
 * @param value The value to set.
 */
void __export cfg_setbool(cfg_t *cfg, const char *name,
									cfg_bool_t value);
 ...
 * for options without the CFGF_LIST flag set.
 */
void __export cfg_setnbool(cfg_t *cfg, const char *name,
									 cfg_bool_t value, unsigned int index);
 ...
 */
void __export cfg_setstr(cfg_t *cfg, const char *name,
								   const char *value);
 ...
 * for options without the CFGF_LIST flag set.
 */
void __export cfg_setnstr(cfg_t *cfg, const char *name,
									const char *value, unsigned int index);
 ...
 * parameter.
 */
void __export cfg_setlist(cfg_t *cfg, const char *name,
 ...
 * parameter.
 */
void __export cfg_addlist(cfg_t *cfg, const char *name,
									unsigned int nvalues, ...);
 ...
 */
void cfg_opt_nprint_var(cfg_opt_t *opt, unsigned int index,
								  FILE *fp);
 ...
 * @see cfg_print
 */
void cfg_print_indent(cfg_t *cfg, FILE *fp, int indent);
 ...
 * @see cfg_print_func_t
 */
cfg_print_func_t cfg_set_print_func(cfg_t *cfg, const char *name,
											  cfg_print_func_t pf);
